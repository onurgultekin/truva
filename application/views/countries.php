...
<html>
  ...
  <body class="fixed-header ">
        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg m-t-10">
            ...
            <div class="row">
              ...
              <button class="btn btn-primary pull-right addNewCountry" data-toggle="modal" data-target="#addNewCountryModal">Yeni Ülke Ekle</button>
              </div>
              <div class="col-md-4 pull-left" style="padding-left: 0px">
                <div class="col-xs-12">
                <input type="text" id="search-table" class="form-control pull-left" placeholder="Ülke Ara">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <tbody>
                ...
                foreach ($countries as $key => $country) {
                  echo '<tr id="'.$country->CountryID.'">
                    <td>'.$country->BinaryCode.'</td>
                    <td>'.$country->TripleCode.'</td>
                    <td>'.$country->CountryName.'</td>
                    <td>'.$country->PhoneCode.'</td>
                    <td><div class="pull-left"><button class="btn btn-warning getCountryDetails btn-xs m-r-10" id="duzenle">Düzenle</button><button class="btn btn-danger deleteCountryModal btn-xs">Sil</button></div></td>
                  </tr>';
                }
                ?>
              </tbody>
        ...
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
              ...
              <h5>Ülke <span class="semi-bold">Bilgileri</span></h5>
              <p class="p-b-10">Aşağıda ülke ile ilgili bilgileri bulabilirsiniz.</p>
            </div>
            <div class="modal-body">
              <form role="form" id="updateCountryData">
                <div class="form-group appendCountryDataHere">
                </div>
                <button type="submit" class="btn btn-primary m-t-5 updateCountry">Bilgileri Düzenle</button>
    ...
    <div class="modal fade stick-up disable-scroll" id="addNewCountryModal" role="dialog" aria-hidden="false">
      <div class="modal-dialog ">
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
              ...
              <h5>Yeni Ülke <span class="semi-bold">Ekle</span></h5>
            </div>
            <div class="modal-body" style="overflow:hidden;">
              <form role="form" class="form-group" id="appendNewCountryData">
              <?php 
              ...
              ?>
                <button type="submit" class="btn btn-primary addNewCountryButton">Yeni Ülke Ekle</button>
    ...
    <div class="modal fade slide-right" id="modalSlideLeft" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <h5 class="text-primary "><span class="semi-bold countryNameinModal"></span> adlı ülkeyi silmek istediğinizden emin misiniz? Lütfen bu işlemi geri alamayacağınızı unutmayın.</h5>
      <br>
      <button type="button" class="btn btn-success btn-block deleteCountryButton">Evet</button>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        getDistrictsInModal();
        getAreasInModal();
        getDetails(".getCountryDetails","/general/getCountryById","countryId",".appendCountryDataHere");
        $("#appendNewCountryData").validate({
          submitHandler: function(form) {
            addNewCountry();
            }
        });
        $("#updateCountryData").validate({
          submitHandler: function(form) {
            updateCountry();
            }
        });
        $("#BinaryCode").mask("aa");
        $("#TripleCode").mask("aaa");
        $("#PhoneCode").mask("999999");
        $("#addNewCountryModal").on("shown.bs.modal",function(){
          setTimeout(function () {$('select').select2();}, 300);
        })
        $("body").on("click",".deleteCountryModal",function(){
          var userId = $(this).parents("tr").attr("id");
          var userName = $(this).parents("tr").find("td:eq(2)").html();
          $(".countryNameinModal").html(userName);
          $(".deleteCountryButton").attr("id",userId);
          $("#modalSlideLeft").modal();
        })
        $("body").on("click",".deleteCountryButton",function(){
