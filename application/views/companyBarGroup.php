...
<html>
  ...
  <body class="fixed-header ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          ...
          <div class="jumbotron  no-margin" data-pages="parallax">
            ...
            <h3 class="">Şirket Bar Grup Listesi</h3>
            </div>
            </div>
            </div>
          <!-- END JUMBOTRON -->
          ...
          <div class="container-fluid container-fixed-lg m-t-10">
            ...
            <div class="row">
              ...
              <button class="btn btn-primary pull-right addNewCompanyBarGroup m-b-10" data-toggle="modal" data-target="#addNewCompanyBarGroupModal">Yeni Bar Grubu Ekle</button>
              </div> -->
              <div class="col-md-4 pull-left" style="padding-left: 0px">
                <div class="col-xs-12">
                <input type="text" id="search-table" class="form-control pull-left" placeholder="Şirket Bar Grubu Ara">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <tbody>
                ...
                foreach ($barGroups as $key => $barGroup) {
                  echo '<tr id="'.$barGroup->CompanyID.'">
                    <td>'.$barGroup->CompanyName.'</td>
                    <td>'.$barGroup->ToplamBar.'</td>
                    <td><div class="pull-left"><button class="btn btn-warning getCompanyBarGroupDetails btn-xs m-r-10" id="duzenle">Bar Grubu Ata</button><button class="btn btn-danger deleteCompanyBarGroupModal btn-xs">Sil</button></div></td>
                  </tr>';
                }
                ?>
              </tbody>
        ...
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
              ...
              <h5>Şirket Bar Grubu <span class="semi-bold">Bilgileri</span></h5>
              <p class="p-b-10">Aşağıda şirket bar grubu ile ilgili bilgileri bulabilirsiniz.</p>
            </div>
    ...
    <div class="modal fade stick-up disable-scroll" id="addNewCompanyBarGroupModal" role="dialog" aria-hidden="false">
      <div class="modal-dialog ">
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
            ...
            <div class="modal-body" style="overflow:hidden;">
              <form role="form" class="form-group" id="appendNewCompanyBarGroupData">
              <?php 
              ...
              ?>
                <button type="submit" class="btn btn-primary addNewCompanyBarGroupButton">Yeni Alkol Grubu Ekle</button>
    ...
    <div class="modal fade slide-right" id="modalSlideLeft" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <h5 class="text-primary "><span class="semi-bold CompanyBarGroupNameinModal"></span> adlı alkol grubunu silmek istediğinizden emin misiniz? Lütfen bu işlemi geri alamayacağınızı unutmayın.</h5>
      <br>
      <button type="button" class="btn btn-success btn-block deleteCompanyBarGroupButton">Evet</button>
    ...
    <script type="text/javascript">
      $(function(){
        ...
        $("#addNewCompanyBarGroupModal").on("shown.bs.modal",function(){
          setTimeout(function () {$('select').select2();}, 300);
        })
        $("body").on("click",".deleteCompanyBarGroupModal",function(){
          var userId = $(this).parents("tr").attr("id");
          var userName = $(this).parents("tr").find("td:eq(2)").html();
          $(".deleteModalError").html('').addClass("unvisible");
          $(".CompanyBarGroupNameinModal").html(userName);
          $(".deleteCompanyBarGroupButton").attr("id",userId);
          $("#modalSlideLeft").modal();
        })
        $("body").on("click",".deleteCompanyBarGroupButton",function(){
          var CompanyBarGroupID = $(this).attr("id");
          $(".deleteModalError").html('Lütfen bekleyiniz...').removeClass("unvisible");
          $.ajax({
            type:"POST",
            url:base_url+"/admin/deleteCompanyBarGroup",
            data:{CompanyBarGroupID:CompanyBarGroupID},
            success:function(data){
              $(".deleteModalError").html(data.message).removeClass("unvisible");
              $("table").find("tr#"+CompanyBarGroupID).fadeOut(500,function(){
                getCompanyBarGroups()
              })
            }
          })
