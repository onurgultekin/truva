...
<html>
  ...
  <body class="fixed-header ">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" id="updateAlcoholTypeData">
                <div class="form-group appendAlcoholTypeDataHere">
                </div>
                <button type="submit" class="btn btn-primary m-t-5 updateAlcoholType">Bilgileri Düzenle</button>
    ...
    <script type="text/javascript">
      $(function(){
        initTable();
        getDetails(".getAlcoholTypeDetails","/general/getAlcoholTypeById","alcoholTypeId",".appendAlcoholTypeDataHere");
        ...
        $("#updateAlcoholTypeData").validate({
          submitHandler: function(form) {
            updateAlcoholType();
            }
        });
        $("#addNewAlcoholTypeModal").on("shown.bs.modal",function(){
        ...
        $("body").on("click",".deleteAlcoholTypeButton",function(){
          var AlcoholTypeID = $(this).attr("id");
          $(".deleteModalError").html('Lütfen bekleyiniz...').removeClass("unvisible");
          $.ajax({
            type:"POST",
            url:base_url+"/admin/deleteAlcoholType",
            data:{AlcoholTypeID:AlcoholTypeID},
            success:function(data){
              $(".deleteModalError").html(data.message).removeClass("unvisible");
              $("table").find("tr#"+AlcoholTypeID).fadeOut(500,function(){
                getAlcoholTypes()
              })
            }
          })
