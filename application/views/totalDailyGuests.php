...
<html>
  ...
  <body class="fixed-header ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          ...
          <div class="jumbotron  no-margin" data-pages="parallax">
            ...
            <h3 class="">Şirket Günlük Kişi Listesi</h3>
            </div>
            </div>
            </div>
          <!-- END JUMBOTRON -->
          ...
          <div class="container-fluid container-fixed-lg m-t-10">
            ...
            <div class="row">
              ...
              <button class="btn btn-primary pull-right addNewCompanyDailyGuest m-b-10" data-toggle="modal" data-target="#addNewCompanyDailyGuestModal">Yeni Günlük Kişi Ekle</button>
              </div>
              <div class="col-md-4 pull-left" style="padding-left: 0px">
                <div class="col-xs-12">
                <input type="text" id="search-table" class="form-control pull-left" placeholder="Şirket Günlük Kişi Ara">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <tbody>
                <?php
                foreach ($totalDailyGuests as $key => $totalDailyGuest) {
                  echo '<tr id="'.$totalDailyGuest->TotalDailyGuestID.'">
                    <td>'.$totalDailyGuest->CompanyName.'</td>
                    <td>'.$totalDailyGuest->Date.'</td>
                    <td>'.$totalDailyGuest->TotalGuest.'</td>
                    <td><div class="pull-left"><button class="btn btn-warning getCompanyDailyGuestDetails btn-xs m-r-10" id="duzenle">Düzenle</button><!-- <button class="btn btn-danger deleteCompanyDailyGuestModal btn-xs">Sil</button> --></div></td>
                  </tr>';
                }
                ?>
              </tbody>
        ...
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
              ...
              <h5>Günlük Kişi <span class="semi-bold">Bilgileri</span></h5>
              <p class="p-b-10">Aşağıda günlük kişi ile ilgili bilgileri bulabilirsiniz.</p>
            </div>
            <div class="modal-body">
              <form role="form" id="updateCompanyDailyGuestData">
                <div class="form-group appendCompanyDailyGuestDataHere">
                </div>
                <button type="submit" class="btn btn-primary m-t-5 updateCompanyDailyGuest">Bilgileri Düzenle</button>
    ...
    <div class="modal fade stick-up disable-scroll" id="addNewCompanyDailyGuestModal" role="dialog" aria-hidden="false">
      <div class="modal-dialog ">
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
            ...
            <div class="modal-body" style="overflow:hidden;">
              <form role="form" class="form-group" id="appendNewCompanyDailyGuestData">
              <?php 
                ...
                if($field["type"]!="select"){
                  ...
                  echo '<div class="form-group form-group-default form-group-default-select2 required">
                        <label class="">'.$field["name"].'</label>
                          <select class="full-width '.$field["class"].' '.$field["disabled"].'" name="'.$field["id"].'" id="'.$field["id"].'" data-placeholder="Günlük Kişi seçin" data-init-plugin="select2" required data-msg="'.$message.'">
              ...
              ?>
                <button type="submit" class="btn btn-primary addNewCompanyDailyGuestButton">Yeni Günlük Kişi Ekle</button>
    ...
    <div class="modal fade slide-right" id="modalSlideLeft" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <h5 class="text-primary "><span class="semi-bold CompanyDailyGuestNameinModal"></span> adlı şirkete ait günlük kişi sayısını silmek istediğinizden emin misiniz? Lütfen bu işlemi geri alamayacağınızı unutmayın.</h5>
      <br>
      <button type="button" class="btn btn-success btn-block deleteCompanyDailyGuestButton">Evet</button>
      ...
      $(function(){
        ...
        $("#appendNewCompanyDailyGuestData").validate({
          submitHandler: function(form) {
            addNewCompanyDailyGuest();
            }
        });
        $("#updateCompanyDailyGuestData").validate({
          submitHandler: function(form) {
            updateCompanyDailyGuest();
            }
        });
        $("#addNewCompanyDailyGuestModal").on("shown.bs.modal",function(){
          setTimeout(function () {
            $('select').select2();
