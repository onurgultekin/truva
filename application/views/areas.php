...
<html>
  ...
  <body class="fixed-header ">
        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg m-t-10">
            ...
            <div class="row">
              ...
              <button class="btn btn-primary pull-right addNewArea" data-toggle="modal" data-target="#addNewAreaModal">Yeni Semt Ekle</button>
              </div>
              <div class="col-md-4 pull-left" style="padding-left: 0px">
                <div class="col-xs-12">
                <input type="text" id="search-table" class="form-control pull-left" placeholder="Semt Ara">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <tbody>
                ...
                foreach ($areas as $key => $area) {
                  echo '<tr id="'.$area->AreaID.'">
                    <td>'.$area->AreaName.'</td>
                    <td>'.$area->CountyName.'</td>
                    <td><div class="pull-left"><button class="btn btn-warning getAreaDetails btn-xs m-r-10" id="duzenle">Düzenle</button><button class="btn btn-danger deleteAreaModal btn-xs">Sil</button></div></td>
                  </tr>';
                }
                ?>
              </tbody>
        ...
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
              ...
              <h5>Semt <span class="semi-bold">Bilgileri</span></h5>
              <p class="p-b-10">Aşağıda semt ile ilgili bilgileri bulabilirsiniz.</p>
            </div>
            <div class="modal-body">
              <form role="form" id="updateAreaData">
                <div class="form-group appendAreaDataHere">
                </div>
                <button type="submit" class="btn btn-primary m-t-5 updateArea">Bilgileri Düzenle</button>
    ...
    <div class="modal fade stick-up disable-scroll" id="addNewAreaModal" role="dialog" aria-hidden="false">
      <div class="modal-dialog ">
        <div class="modal-content-wrapper">
          <div class="modal-content">
            <div class="modal-header clearfix text-left">
              ...
              <h5>Yeni Semt <span class="semi-bold">Ekle</span></h5>
            </div>
            <div class="modal-body" style="overflow:hidden;">
              <form role="form" class="form-group" id="appendNewAreaData">
              <?php 
              ...
              ?>
                <button type="submit" class="btn btn-primary addNewAreaButton">Yeni İlçe Ekle</button>
    ...
    <div class="modal fade slide-right" id="modalSlideLeft" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <h5 class="text-primary "><span class="semi-bold areaNameinModal"></span> adlı semti silmek istediğinizden emin misiniz? Lütfen bu işlemi geri alamayacağınızı unutmayın.</h5>
      <br>
      <button type="button" class="btn btn-success btn-block deleteAreaButton">Evet</button>
    ...
    <script type="text/javascript">
      $(function(){
        initTable();
        getDetails(".getAreaDetails","/general/getAreaById","areaId",".appendAreaDataHere");
        $("#appendNewAreaData").validate({
          rules: {
            CountyID:{min:1},
        },
        ...
        $("#updateAreaData").validate({
          submitHandler: function(form) {
            updateArea();
            }
        });
        $("#addNewAreaModal").on("shown.bs.modal",function(){
          setTimeout(function () {$('select').select2();}, 300);
        })
        $("body").on("click",".deleteAreaModal",function(){
          var userId = $(this).parents("tr").attr("id");
          var userName = $(this).parents("tr").find("td:eq(0)").html();
          $(".areaNameinModal").html(userName);
          $(".deleteAreaButton").attr("id",userId);
          $("#modalSlideLeft").modal();
        })
        $("body").on("click",".deleteAreaButton",function(){
          var AreaID = $(this).attr("id");
          $(".deleteModalError").html('Lütfen bekleyiniz...').removeClass("unvisible");
          $.ajax({
            type:"POST",
            url:base_url+"/admin/deleteArea",
            data:{AreaID:AreaID},
