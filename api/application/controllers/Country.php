...
class Country extends REST_Controller {
	...
	public function getCountry_post(){
		$message = $this->Country_model->getCountry($this->post());
		$this->set_response($message, REST_Controller::HTTP_OK);
	}
	public function addCountry_post(){
		$message = $this->Country_model->addCountry($this->post());
		$this->set_response($message, REST_Controller::HTTP_OK);
	}
	public function updateCountry_post(){
		$message = $this->Country_model->updateCountry($this->post());
		$this->set_response($message, REST_Controller::HTTP_OK);
	}
	public function deleteCountry_post(){
		$message = $this->Country_model->deleteCountry($this->post());
		$this->set_response($message, REST_Controller::HTTP_OK);
	}
}